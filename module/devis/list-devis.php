...
$new = $chemin.$wintype.".php?page=insert&cat=".$cat."&idaffaire=".$_REQUEST['sh_url_affaire_devis']."&vpb=".$vpb;
...
$laselection = "
a.id id".$cat.", a.numerodevis numerodevis , a.paxcalcul paxcalcul , a.coutderevien coutderevien , a.prixdevente prixdevente , a.nom ".$cat.",

c.id idaffaire 	, c.nom affaire,

p.id idphasedevis , 	p.phasedevis phasedevis, 	

u.id iduser , 	u.pseudo assigne";


$larecherche = "FROM `".$cat."` a
					LEFT JOIN affaire c ON c.id = a.idaffaire
					LEFT JOIN phasedevis p ON p.id = a.phasedevis
					LEFT JOIN user u ON u.id = a.assigne";
					
					
$recherche[0]['nom'] = 'numero';
$recherche[0]['type'] = 'shclassic';
$recherche[0]['where'][0] = 'a.numerodevis';
$recherche[0]['orderby'] = 'a.numerodevis';

$recherche[1]['nom'] = 'devis';
...
$recherche[2]['nom'] = 'affaire';
$recherche[2]['type'] = 'shpopidnom';
$recherche[2]['where'][0] = 'c.id';
$recherche[2]['where'][1] = 'c.nom';
$recherche[2]['orderby'] = 'c.nom';
$recherche[2]['link'] = "page=insert&cat=affaire&idaffaire=";

$recherche[3]['nom'] = 'phasedevis';
$recherche[3]['type'] = 'shselectbox';
$recherche[3]['where'][0] = 'a.phasedevis';
$recherche[3]['where'][1] = 'phasedevis';
$recherche[3]['where'][2] = 'phasedevis';
$recherche[3]['orderby'] = 'p.phasedevis';


$recherche[4]['nom'] = 'pax';
$recherche[4]['type'] = 'shclassic';
$recherche[4]['where'][0] = 'a.paxcalcul';
$recherche[4]['orderby'] = 'a.paxcalcul';

$recherche[5]['nom'] = 'coutderevien';
$recherche[5]['type'] = 'shclassic';
$recherche[5]['where'][0] = 'a.coutderevien';
$recherche[5]['orderby'] = 'a.coutderevien';

$recherche[6]['nom'] = 'prixdevente';
$recherche[6]['type'] = 'shclassic';
$recherche[6]['where'][0] = 'a.prixdevente';
$recherche[6]['orderby'] = 'a.prixdevente';
...
<input type="hidden" name = "idaffaire" value="<?php echo $_REQUEST['sh_url_affaire_devis']; ?>" >
...
<script>
	...
	//
	function popup_shared_insert(){ var popy= window.open('popup.php?page=insert&cat=<?php echo $cat; ?>&idaffaire=<?php echo $_REQUEST['sh_url_affaire_devis']; ?>&vpb=<?php echo $vpb ;?>','popup_form','menubar=no,status=no,top=50%,left=50%,height=700,width=1000,scrollbars=1') } 
