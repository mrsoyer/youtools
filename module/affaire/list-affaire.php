...
$laselection = "
a.id id".$cat.", 	a.nom affaire, 	a.debutsejour debutsejour, 	a.finsejour finsejour, 	o.origine origine, 	s.societe societe, 	u.pseudo assigne, 	c.nom client, 	f.nom fournisseur, 	a.echeance echeance, 	p.phasedevente phasedevente, 	a.description description, 	a. pax pax,  	a.nompax nompax, 	t.type type, 	a.numero numero, 	t.id 	idtype, 	o.id 	idorigine, 	s.id 	idsociete, c.id	idclient, f.id	idfournisseur, p.id 	idphasedevente, 	u.id 	iduser";

$larecherche = "FROM `".$cat."` a
					LEFT JOIN type t  ON t.id = a.type
					LEFT JOIN origine o  ON o.id = a.origine
					LEFT JOIN societe s ON s.id = a.societe
					LEFT JOIN client c ON c.id = a.client
					LEFT JOIN fournisseur f ON f.id = a.fournisseur
					LEFT JOIN phasedevente p ON p.id = a.phasedevente
					LEFT JOIN user u ON u.id = a.assigne";
					
					
$recherche[0]['nom'] = 'numero';
$recherche[0]['type'] = 'shclassic';
$recherche[0]['where'][0] = 'a.numero';
$recherche[0]['orderby'] = 'a.numero';

$recherche[1]['nom'] = 'affaire';
...
$recherche[2]['nom'] = 'client';
$recherche[2]['type'] = 'shpopidnom';
$recherche[2]['where'][0] = 'c.id';
$recherche[2]['where'][1] = 'c.nom';
$recherche[2]['orderby'] = 'c.nom';
$recherche[2]['link'] = "page=insert&cat=client&idclient=";

$recherche[3]['nom'] = 'phasedevente';
$recherche[3]['type'] = 'shselectbox';
$recherche[3]['where'][0] = 'a.phasedevente';
$recherche[3]['where'][1] = 'phasedevente';
$recherche[3]['where'][2] = 'phasedevente';
$recherche[3]['orderby'] = 'p.phasedevente';

$recherche[4]['nom'] = 'debutsejour';
$recherche[4]['type'] = 'shdatedea';
$recherche[4]['where'][0] = 'a.debutsejour';
$recherche[4]['orderby'] = 'a.`debutsejour`';

$recherche[5]['nom'] = 'finsejour';
$recherche[5]['type'] = 'shdatedea';
$recherche[5]['where'][0] = 'a.finsejour';
$recherche[5]['orderby'] = 'a.`finsejour`';

$recherche[6]['nom'] = 'societe';
$recherche[6]['type'] = 'shselectbox';
$recherche[6]['where'][0] = 'a.societe';
$recherche[6]['where'][1] = 'societe';
$recherche[6]['where'][2] = 'societe';
$recherche[6]['orderby'] = 's.`societe`';

$recherche[7]['nom'] = 'assigne';
$recherche[7]['type'] = 'shselectbox';
$recherche[7]['where'][0] = 'a.assigne';
$recherche[7]['where'][1] = 'user';
$recherche[7]['where'][2] = 'pseudo';
$recherche[7]['orderby'] = 'u.`pseudo`';
...
$laliste .= "";
	...
	while($data = mysql_fetch_assoc($req)) {
		...
		$data['debutsejour'] = explode("-", $data['debutsejour']);
		$data['debutsejour'] = $data['debutsejour'][2]."/".$data['debutsejour'][1]."/".$data['debutsejour'][0];
		
		$data['finsejour'] = explode("-", $data['finsejour']);
		$data['finsejour'] = $data['finsejour'][2]."/".$data['finsejour'][1]."/".$data['finsejour'][0];
