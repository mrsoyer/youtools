...
$laselection = "
a.id id".$cat.", 	a.nom fournisseur, 	a. codecompta codecompta, 	a.telbureau telbureau, a.telmobile telmobile, a.teldiv teldiv, a.fax fax, a.secondmail secondmail, a.ville ville, a.codepostal codepostal, a.pays pays, a.adresse adresse, 	
...
$larecherche = "FROM `fournisseur` a
	...
	while($data = mysql_fetch_assoc($req)) {
			 ...
			 /*window.opener.document.formulairecontact.sh_relatif_tache.value=document.formulairecontact_".$cat.".text".$data['id'.$cat].".value;
			  ...
			  <script type='text/javascript'>
				...
				".str_replace("[row]",$_REQUEST['row'],str_replace("[id".$cat."]",$data['id'.$cat],$js))."
