...
if(isset($contactlie) && $contactlie != ""){
...
function fournisseur0(){ var popy= window.open('popup.php?page=list&cat=contact&js=insert-<?php echo $cat;?>-valideopenerformcontact','popup_form','menubar=no,status=no,top=50%,left=50%,height=700,width=900,scrollbars=1') } 
