...
$laselection = "
a.id id".$cat.", 	a.nom contact, 	a.prenom prenom, 	a.telbureau telbureau, a.telmobile telmobile, a.teldiv teldiv, a.fax fax, a.secondmail secondmail, a.ville ville, a.codepostal codepostal, a.pays pays, a.adresse adresse, a.email email , a.telbureau telbureau, a.telmobile telmobile,	
...
$recherche[0]['nom'] = 'contact';
$recherche[0]['type'] = 'shclassic';
$recherche[0]['where'][0] = 'a.nom';
$recherche[0]['orderby'] = 'a.nom';
$recherche[0]['link'] = "page=insert&cat=".$cat."&id".$cat."=";


$recherche[2]['nom'] = 'prenom';
$recherche[2]['type'] = 'shclassic';
$recherche[2]['where'][0] = 'a.prenom';
$recherche[2]['orderby'] = 'a.prenom';

$recherche[3]['nom'] = 'email';
$recherche[3]['type'] = 'shclassic';
$recherche[3]['where'][0] = 'a.email';
$recherche[3]['orderby'] = 'a.email';

$recherche[4]['nom'] = 'telbureau';
$recherche[4]['type'] = 'shclassic';
$recherche[4]['where'][0] = 'a.telbureau';
$recherche[4]['orderby'] = 'a.telbureau';

$recherche[5]['nom'] = 'telmobile';
$recherche[5]['type'] = 'shclassic';
$recherche[5]['where'][0] = 'a.telmobile';
$recherche[5]['orderby'] = 'a.telmobile';


$recherche[6]['nom'] = 'ville';
$recherche[6]['type'] = 'shclassic';
$recherche[6]['where'][0] = 'a.ville';
$recherche[6]['orderby'] = 'a.ville';

$recherche[7]['nom'] = 'codepostal';
$recherche[7]['type'] = 'shclassic';
$recherche[7]['where'][0] = 'a.codepostal';
$recherche[7]['orderby'] = 'a.codepostal';

$recherche[8]['nom'] = 'pays';
$recherche[8]['type'] = 'shclassic';
$recherche[8]['where'][0] = 'a.pays';
$recherche[8]['orderby'] = 'a.pays';
